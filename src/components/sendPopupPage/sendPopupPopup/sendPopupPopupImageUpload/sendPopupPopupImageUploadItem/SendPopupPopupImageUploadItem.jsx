...
import styles from './SendPopupPopupImageUploadItem.module.css'

const SendPopupPopupImageUploadItem = ({src, alt, text, size, onChange}) => {
...
export default SendPopupPopupImageUploadItem